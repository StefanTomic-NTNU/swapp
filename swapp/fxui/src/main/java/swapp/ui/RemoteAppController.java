...
public class RemoteAppController {
  ...
  void addSwappItemButtonClicked() {
    if (!nameField.getText().isBlank()) {
      ...
      SwappItem item = new SwappItem(name,
          /* statusChoiceBox.getSelectionModel().getSelectedItem().toString() */ status, description, contactInfo);
  ...
  public void viewSwappItem() throws IOException {
    ...
    System.out.println(remoteSwappAccess.getSwappItem(listView.getSelectionModel().getSelectedItem().getName()) + " getSwappItem()");
    SwappItem swappItem = remoteSwappAccess.getSwappItem(listView.getSelectionModel().getSelectedItem().getName());
    System.out.println(remoteSwappAccess.getSwappList().getItems().toString() + " view list");
    ...
    if (deleteFlag){
      remoteSwappAccess.removeSwappItem(newItem.getName());
    }
    else if (!remoteSwappAccess.getSwappList().sameSwappItemInfo(newItem)) {
      SwappItemList newList = new SwappItemList(remoteSwappAccess.getSwappList().getItems());
      System.out.println(newList.getItems().toString() + "before put no change");
      newList.putSwappItem(newItem);
      System.out.println(newList.getItems().toString() + "before put with change");
      remoteSwappAccess.putSwappList(newList);
      System.out.println(newList.getItems().toString() + "after put with change");
    }
    updateSwappListView();
    itemController = null;
    swappItem = null;
