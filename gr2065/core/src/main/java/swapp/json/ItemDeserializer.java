...
public class ItemDeserializer extends JsonDeserializer<Item> {
  ...
  @Override
  public Item deserialize(final JsonParser jsonParser, final DeserializationContext deserContext)
  ...
  public Item deserialize(final JsonNode jsonNode) throws JsonProcessingException {
    if (jsonNode instanceof ObjectNode) {
      ...
      final String itemName = objectNode.get(ItemSerializer.ITEMNAME).asText();
